...
public class GorkoMapsterConfig : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        config.NewConfig<Restaurant, Component>()
            ...
            .Map(x => x.AvatarUrl, y => y.Avatar ?? Infrastructure.Common.AppData.DefaultAvatarUrl)
            .Ignore(x => x.Album)
            .Ignore(x => x.Capacity!)
            .Ignore(x => x.City)
            .Ignore(x => x.Category)
        ...
        config.NewConfig<Clients.Gorko.Models.Review, Domain.NoSQL.ValueObjects.Review>()
            ...
            .Map(x => x.AvatarUrl, y => y.UserAvatar ?? Infrastructure.Common.AppData.DefaultAvatarUrl)
        ...
        config.NewConfig<ICollection<Contact>, Contacts>()
            ...
            .Map(x => x.PhoneNumbers, y =>
                y.Where(x => x.Key == GorkoStaticData.PhoneNumber)
                .Select(x => x.Value)
                .ToList());
