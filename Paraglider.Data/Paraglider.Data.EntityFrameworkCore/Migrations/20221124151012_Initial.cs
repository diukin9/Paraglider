    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Plannings_PlanningId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetExternalAuthInfo", x => x.Id);
                    table.UniqueConstraint("AK_AspNetExternalAuthInfo_ExternalProvider_ExternalId", x => new { x.ExternalProvider, x.ExternalId });
                    table.ForeignKey(
                        name: "FK_AspNetExternalAuthInfo_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetExternalAuthInfo_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_PlanningId",
                table: "AspNetUsers",
                column: "PlanningId",
                unique: true);
